"""
Django settings for xssor project.
...
PROJECT_DIR = os.path.join(BASE_DIR, 'xssor')
...
WSGI_APPLICATION = 'xssor.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    ("payload", os.path.join(PROJECT_DIR, 'payload')),
]
